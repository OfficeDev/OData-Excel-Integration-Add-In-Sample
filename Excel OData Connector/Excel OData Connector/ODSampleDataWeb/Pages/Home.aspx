...
<body>
    ...
    <div class="panel panel-default">
        <div class="panel-heading modes mode-list">
            <img alt="Brand" src="../../Images/odata_logo.png" />
        </div>
        <div class="loading">Loading...</div>
        <div class="panel-body loaded non-expandtable-area" style="display: none">
        ...
        <div class="panel-footer loaded non-expandtable-area modes mode-list mode-diff" style="display: none">
            ...
            <button id="upload-data-feed" type="button" class="btn btn-primary modes mode-diff" disabled="disabled">Update</button>
        </div>
