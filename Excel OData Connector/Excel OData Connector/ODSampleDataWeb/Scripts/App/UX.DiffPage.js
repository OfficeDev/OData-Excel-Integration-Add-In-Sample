        ...
        (function (DiffPage) {
            var DiffPageDelegator = (function () {
                ...
                DiffPageDelegator.prototype.initializeButtons = function () {
                    var _this = this;
                    $("#back-to-detail").click(ODataUX.DataFeedDetailPage.switchToDetailPage);
                    ...
                    $("#upload-data-feed").click(function () {
                        ...
                        ODSampleData.uploadChangeToOData(ODataUX.DataFeedDetailPage.switchToDetailPage);
                    });
                };
                DiffPageDelegator.onDiffListItemCountChanged = function (count) {
                    ...
                    $("#upload-data-feed").prop("disabled", count === 0);
                };
